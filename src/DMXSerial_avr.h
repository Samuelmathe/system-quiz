...
// Projet DMX Quiz (Mega 2560) : DMX sur USART3 / Serial3 (broches 14–15) pour garder Serial (USB) pour le PC.
// Définir DMX_FORCE_USART0 avant d’inclure la lib pour revenir au shield DMX sur le port série principal.
#if defined(ARDUINO_AVR_MEGA2560) && defined(USART3_RX_vect) && !defined(DMX_FORCE_USART0)
#ifndef DMX_USE_PORT3
...
// ATmega2560 : USART3 = Arduino Serial3 (TX3=14, RX3=15) — DMX shield sur ce port
...
#elif !defined(DMX_USE_PORT1) && !defined(DMX_USE_PORT3) && defined(USART0_RX_vect)
// These definitions are used on ATmega1280 and ATmega2560 boards
// like the Arduino MEGA boards (USART0 = Serial / USB-série)
#define UCSRnA UCSR0A
#define RXCn RXC0
#define TXCn TXC0
#define UCSRnB UCSR0B
